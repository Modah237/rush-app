  ...
  return (
    <div className="page-enter flex flex-col gap-5 px-4 md:px-0 mt-4 pb-12">
      ...
      <div className="flex items-center gap-3">
        <Link href="/merchant" className="w-10 h-10 rounded-full bg-surface shadow-warm-1 flex items-center justify-center text-ink cursor-pointer hover:text-brand transition-colors">
          <Icon name="chevL" size={22} stroke={2.3} />
        </Link>
        <div>
          <h2 className="font-extrabold text-[13px] text-brand uppercase tracking-wider">merchant.rush</h2>
      ...
      <div className="bg-gradient-to-br from-ink to-ink-light text-white p-5 rounded-lg flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-warm-2">
        ...
        <div className="flex items-center gap-3">
          <span className={`badge font-black text-[11px] px-2.5 py-1 rounded-pill ${
            isSubscribed ? 'bg-[#E6F6EC] text-[#15A05A]' : 'bg-[#FFE9EB] text-[#F50012]'
          }`}>
          ...
          {orders.map((o) => (
            <div key={o.id} className="card bg-surface p-4.5 rounded-lg shadow-warm-1 flex flex-col gap-3">
              <div className="flex items-center justify-between">
                ...
                <span className="badge bg-[#FFF1E2] text-[#E2730B] font-black text-[11px] px-2 py-0.5 rounded-pill">
                  {o.status}
                </span>
              </div>
          ...
          <div className="border border-border-warm rounded-md p-5 flex flex-col md:flex-row justify-between md:items-center gap-4">
            ...
            {!isSubscribed ? (
              ...
              <div className="text-right">
                <span className="badge bg-[#E6F6EC] text-[#15A05A] font-black text-[12px] px-3 py-1 rounded-pill">
                  Abonnement actif
                </span>
